let trendyBox = document.getElementById("trendy-box");
let detailBox = document.getElementById("trendy-detail-box");
let detail = document.getElementById("trendy-detail");

function initApp(categoryId = "") {
  let trendyProducts = products.filter((product) => product?.type == "trendy");

  trendyProducts.forEach((value, key) => {
    console.log(value);
